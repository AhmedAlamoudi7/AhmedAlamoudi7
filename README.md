...
Database Design * MSSQL * Angular.js * Node.js * ASP.NET MVC 5 * ASP.NET CORE * EntityFramework * Dapper * Identity * IdentityServer * SignalR * git/github * docker * JavaScript * python  * django * linux system manager * Pentesting * MicroServices * BlockChain * Computer Vision 
